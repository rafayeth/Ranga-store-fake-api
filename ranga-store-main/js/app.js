...
const showProducts = (products) => {
  ...
  const allprodut =  document.getElementById("all-products")
...
const result = document.getElementById('single-products')
result.textContent= ''
const div = document.createElement('div')
